...
# Conflict density 1 (good example)
p1 <- ggplot(conflict_density) +
...
showtext_auto()
print(p1)
ggsave_showtext("plot/conflict_density_1.png", device = "png", width = 5, height = 5)
showtext_auto(enable = FALSE)

# Conflict density 2 (poor example)
p2 <- ggplot(conflict_density) +
...
print(p2)
ggsave_showtext("plot/conflict_density_2.png", device = "png", width = 5, height = 5)
